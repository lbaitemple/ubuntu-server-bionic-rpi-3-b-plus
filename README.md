...
```
Please include the following content and make sure you generate your password hash (see line include command ![#f03c15](echo -n [password] | iconv -t UTF-16LE | openssl md4)
```
network:
        version: 2
        renderer: networkd
